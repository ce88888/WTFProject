...
# Create dummies
dummies <- dummyVars(~ MONTH +  SEASON, data = class.data)
...
# model.train.data <- as.matrix(train.data)
# 
# model.test.data <- as.matrix(test.data)
# 
...
#   glmnet(
#     model.train.data,
#     as.factor(model.train.data$STRIKE),
#     family = "binomial",
...
# coef(md3)
# 
# roc(as.factor(model.test.data$STRIKE), predict(md3, model.test.data, type = "response"))
# 
...
# perf <- performance(prediction(preds, model.test.data$STRIKE), 'tpr', 'fpr')
# 
# plot(perf)
```

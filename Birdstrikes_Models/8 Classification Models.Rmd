...
class.data$FOG <- as.numeric(class.data$FOG)
class.data$SNOW_ICE <- as.numeric(class.data$SNOW_ICE)
...
class.data <-
  class.data %>% filter(!class.data$YEAR %in% c(1995, 1996, 1997, 1998, 1999, 2019))

class.data <- subset(class.data, select = -c(DATE, YEAR, SEASON, MXSPD, SNOW_ICE))

valid.cl.data <- subset(valid.cl.data, select = -c(DATE, YEAR, SEASON, MXSPD, SNOW_ICE))

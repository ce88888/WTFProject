...
model.cla <- c(setdiff(names(model.data.day), c("STRIKECOUNT", "YEAR", "DAYOFWEEK", "HAIL", "DATE", "SLP", "THUNDER", "RAIN_DRIZZLE")))
...
model.reg <- c(setdiff(names(model.data.day), c("STRIKE", "DATE", "YEAR", "HAIL", "DAYOFYEAR", "FOG", "SNOW_ICE", "RAIN_DRIZZLE", "THUNDER")))

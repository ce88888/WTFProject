...
class.data <- subset(class.data, select = -c(DATE, YEAR, SNOW_ICE, STRIKECOUNT, STRIKE, WEEK, RATIO, RATIOP, WDSP, DEWP))
...
var.boruta <-
  Boruta(
    as.factor(RISK) ~ BIRDCOUNT + FLIGHTCOUNT + TEMP + MXSPD + VISIB + PRCP + FOG,
    data = class.data,
    doTrace = 2
  )

...
model.cla <- c(setdiff(names(model.data.day), c("STRIKECOUNT", "COVERH", "SLP", "DAY", "WEEKOFYEAR", "CLOUDH")))
...
model.reg <- c(setdiff(names(model.data.day), c("STRIKE", "DAY", "WEEKOFYEAR", "PRECIP")))

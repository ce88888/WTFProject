...
```{r}
clusterKmeans(upsample.data, k=5, limit = 5, ohse = TRUE, norm = TRUE, seed = 1234)
```

```{r}
clusterKmeans(downsample.data, k=5, limit = 5, ohse = TRUE, norm = TRUE, seed = 1234)
```
